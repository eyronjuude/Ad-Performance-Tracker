      ...
      {employees.map((employee) => {
        ...
        return (
          <section
            ...
            aria-labelledby={`probationary-${employee.acronym}`}
          >
            <h2 className="mb-4">
              <button
                type="button"
                id={`probationary-${employee.acronym}`}
                aria-expanded={isExpanded}
                aria-controls={`probationary-panel-${employee.acronym}`}
            ...
            {isExpanded && (
              <div
                id={`probationary-panel-${employee.acronym}`}
                role="region"
                aria-labelledby={`probationary-${employee.acronym}`}
