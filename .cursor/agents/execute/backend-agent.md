---
name: backend-agent
description: Implements backend code in the Ad Performance Tracker API using the project's FastAPI tech stack. Use when implementing, extending, or refactoring backend routes, services, or tests. Ensures solutions fit the current backend structure and conventions.
model: fast
---
