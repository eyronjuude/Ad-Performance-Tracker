...
| **Check** | Verify, test, audit, debug failures | `tester-agent`, `security-agent`, `debug-agent` |
...
3. **Check** – Tests (tester-agent), security audit (security-agent), or debug pasted errors (debug-agent).
